  ...
  return (
    <div className="pb-20 pt-36">
      <div>
        ...
        <Spotlight className="top-28 left-80 h-[80vh] w-[50vw]" fill="blue" /> {/* TODO: I like green as well...maybe change to that? */}
      </div>
      ...
      <div className="flex justify-center relative my-20 z-10">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
          ...
          <p className="text-center tracking-wider mb-4 text-sm md:text-lg lg:text-2xl">
            Hi, I&apos;m Michael, a FullStack Developer based in Wisconsin.
          </p>
          <a href="#about">
            <MagicButton
              title='Show My Work'
